...
cursor = pygame.image.load('osu-main/cursor.png')
osua = pygame.image.load('osu-main/osua.png')
osub = pygame.image.load('osu-main/osub.png')
osuc = pygame.image.load('osu-main/osuc.png')
map = pygame.image.load('osu-main/map.png')
menu = pygame.image.load('osu-main/menuosu.png')
